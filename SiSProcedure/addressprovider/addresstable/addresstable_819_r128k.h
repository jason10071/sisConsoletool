...
FA_BOOTLOADER_ID_ROM            0x4030          4           \n\
FA_BOOTLOADER_ID_XRAM           0xa0004030      4           \n\
FA_BOOT_CODE_CRC_ROM            0x4048          4           \n\
FA_BOOT_CODE_CRC_XRAM           0xa0004048      4           \n\
FA_MAIN_CODE_CRC_ROM            0x4044          4           \n\
FA_MAIN_CODE_CRC_XRAM           0xa0004044      4           \n\
FA_LAST_ID_ROM                  0x40a0          14          \n\
FA_LAST_ID_XRAM                 0xa00040a0      14          \n\
FA_LAST_TIME_ROM                0x40ac          4           \n\
FA_LAST_TIME_XRAM               0xa00040ac      4           \n\
FA_PRIOR_LAST_ID_ROM            0x40b0          14          \n\
FA_PRIOR_LAST_ID_XRAM           0xa00040b0      14          \n\
FA_PRIOR_LAST_TIME_ROM          0x40bc          4           \n\
FA_PRIOR_LAST_TIME_XRAM         0xa00040bc      4           \n\
